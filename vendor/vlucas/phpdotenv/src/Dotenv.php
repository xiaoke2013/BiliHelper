...
class Dotenv
{
    ...
    /**
     * Set the value to the environment variable with the name.
     * @param string $name
     * @param string $value
     */
    public function setEnvironmentVariable($name, $value){
        $this->loader->setEnvironmentVariableDirect($name, $value);
    }

    /**
     * Clear the environment variable with the name.
     * @param string $name
     */
    public function clearEnvironmentVariable($name){
        $this->loader->setImmutable(true)->clearEnvironmentVariable($name);
    }
}

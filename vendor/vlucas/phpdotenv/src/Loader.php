...
class Loader
{
    ...
    public function setEnvironmentVariable($name, $value = null)
    {
        ...
        $this->setEnvironmentVariableDirect($name, $value);

    }

    /**
     * Direct set the value to environment variable without any handles.
     * @param string $name
     * @param string $value
     */
    public function setEnvironmentVariableDirect($name, $value){
